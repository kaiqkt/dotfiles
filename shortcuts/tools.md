...
Window border highlight via [JankyBorders](https://github.com/FelixKratz/JankyBorders). Active window gets the theme accent (`base0F`, generated by flavours); inactive windows get subtle dark border.
...
```bash
borders active_color=0xffcba6f7  # any 0xAARRGGBB value
```
